    ...
    <>
      <nav className={styles.nav}>
        ...
        <div className={styles.d__none}>
          <a className={styles.link__login} href="/login">
            Zaloguj się
          </a>
          <a className={styles.link__register} href="/registration">
            Zarejestruj się
          </a>
        </div>
      </nav>
      ...
      <ul
        className={`${styles.menu__list} ${
          menuVisible ? styles.menu__show : ""
        }`}
      >
        <li>
          <a className={styles.menu__item} href="/login">
            Zaloguj się
          </a>
        </li>
        <li>
          <a className={styles.menu__item} href="/registration">
            Zarejestruj się
          </a>
        </li>
        <li>
